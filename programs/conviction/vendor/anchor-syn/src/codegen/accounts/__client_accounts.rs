...
pub fn generate(
    ...
    quote! {
        ...
        // VENDOR PATCH (Conviction, 2026-09-10): visibility relaxation so the
        // generated helper module is visible across crate-root boundaries.
        // Upstream emits `pub(crate)` which Rust E0365-rejects when re-exported
        // from `crate::__client_accounts_<ix>` inside `#[program]`. ADR 0002.
